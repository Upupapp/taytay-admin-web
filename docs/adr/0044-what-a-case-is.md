...
* Extends: backend ADR 0007 (one canonical assistance lifecycle) — supersedes nothing in it
* Cross-referenced: `taytay-backend/docs/adr/0044-what-a-case-is.md` (the authoritative copy; ADR numbering follows the backend's sequence)
* Console decision log: extends `DL-52`–`DL-58` and `DL-74`; supersedes none of them
